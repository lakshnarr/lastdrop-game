            ...
            try {
                ...
                if (profile == null) {
                    withContext(Dispatchers.Main) {
                        Toast.makeText(this@ProfileStatsActivity, "Profile not found", Toast.LENGTH_SHORT).show()
                        finish()
                    }
                    return@launch
                }
                ...
                withContext(Dispatchers.Main) {
                    ...
                    // Fade in animation
                    val fadeIn = android.view.animation.AnimationUtils.loadAnimation(this@ProfileStatsActivity, R.anim.fade_in)
                ...
                withContext(Dispatchers.Main) {
                    loadingIndicator.visibility = View.GONE
                    Toast.makeText(this@ProfileStatsActivity, "Error loading stats: ${e.message}", Toast.LENGTH_LONG).show()
                    finish()
                }
            }
        }
